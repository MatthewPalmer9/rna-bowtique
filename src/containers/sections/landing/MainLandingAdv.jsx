        ...
        <>
            <section className="text-gray-600 body-font">
                <div className="white-bg container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
                    ...
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">BOGOHO (placeholder)</h1>
                    <p className="mb-8 leading-relaxed">Tis the season! Lorem ipsum of all sizes. Limited inventory! Buy one, get one HALF OFF! Add to your cart and apply coupon code: BOGOHO</p>
